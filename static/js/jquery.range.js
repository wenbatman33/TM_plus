...
(function ($, window, document, undefined) {
  ...
  jRange.prototype = {
    ...
    init: function (node, options) {
      ...
      if (this.options.direction == 'vertically') {
        this.domNode.addClass('vertically');
      }
    ...
    onDrag: function (pointer, e) {
      ...
      if (this.options.direction == 'vertically') {
        var position = this.options.width - e.clientY + this.domNode.offset().top;
      } else {
    ...
    barClicked: function (e) {
      ...
      if (this.options.direction == 'vertically') {
        var x = this.options.width + this.clickableBar.offset().top - e.pageY;
      } else {
